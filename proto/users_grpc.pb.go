...
func (c *usersClient) UpdateUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedUsersServer) UpdateUser(context.Context, *User) (*emptypb.Empty, error) {
